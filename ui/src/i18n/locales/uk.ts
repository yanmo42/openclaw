...
export const uk: TranslationMap = {
  ...
  newSession: {
    ...
    draft: "Чернетка",
    draftDescription: "Зберігайте цю розмову приватною, доки не опублікуєте її",
  ...
  modelSetup: {
    ...
    prepare: {
      ...
      llamaCppHint:
        "Завантажте локальну модель обсягом приблизно 5,0 ГБ; потрібно 16 ГБ оперативної пам’яті",
    },
    manual: {
